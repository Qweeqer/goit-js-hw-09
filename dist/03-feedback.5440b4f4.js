...
})({"7Ih8d":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "decb603d5440b4f4";
...
let formData = localStorage.getItem(FEEDBACK) ? JSON.parse(feedBackRef) : {};
if (feedBackRef !== null) {
    const { email , message  } = JSON.parse(feedBackRef);
    form.email.value = email ? email : "";
    form.message.value = message ? message : "";
}
form.addEventListener("submit", (0, _lodashThrottleDefault.default)(clearSubmitForm, 500));
form.addEventListener("input", (0, _lodashThrottleDefault.default)(handleInput, 500));
...
function clearSubmitForm(event) {
    ...
    if (form.email.value === "" || form.message.value === "") (0, _notiflixNotifyAio.Notify).failure("Warning! All fields must be filled!");
    else {
        ...
        formData = {};
        (0, _notiflixNotifyAio.Notify).success("Thank you!");
    }
} // <--------------------Чернетка---->
 // <-------------Перевірка вводу---------------------------->
...
},{"lodash.throttle":"bGJVT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","notiflix/build/notiflix-notify-aio":"eXQLZ"}],"bGJVT":[function(require,module,exports) {
var global = arguments[3];
/**
